...
%knapsack([41,50,49,59,55,57,60], [442,525,511,593,546,564,617], 7, 170, BestValue, Matrix)) % -> 1735
%knapsack([70,73,77,80,82,87,90,94,98,106,110,113,115,118,120] , [135,139,149,150,156,163,173,184,192,201,210,214,221,229,240] , 15, 750, BestValue, Matrix) % -> 1458
